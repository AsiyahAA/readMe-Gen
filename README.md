# readMe-Gen
## Description
### Project purpose was to generate a readme file for user input in command terminal of vs code. User would be able to input project information and a new read me file would be generated for the user with information, github link, email link, and license badge if chosen.
## User
